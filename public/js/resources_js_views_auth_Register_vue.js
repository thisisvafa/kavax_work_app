...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    if (this.$route.query.date && this.$route.query.time) {
      ...
      this.queryString = "?date=" + this.query.date + "&time=" + this.query.time; // this.path += this.queryString
    }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.$toast.error("Please accept the terms and conditions.");

                return _context.abrupt("return", false);

              case 3:
                data = {
                  fullName: _this.firstName + " " + _this.lastName,
                  email: _this.email,
                  password: _this.password,
                  username: _this.userName
                };
                _context.next = 6;
                return _services_user_user_service__WEBPACK_IMPORTED_MODULE_2__["default"].Post("auth/register", data);
      ...
      if (this.user.email && this.user.password) {
        ...
        this.$store.dispatch("UserAuth/Login", this.user).then(function (response) {
          if (response.status == 200) {
            _this2.$router.push("/dashboard" + _this2.queryString);

            _this2.$toast.success("Registraion successful.");
          } else {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.form-control[data-v-0a273bdb] {\n    border: 1px solid #74726f;\n    color: #fff;\n}\n.auth form .auth-form-btn[data-v-0a273bdb] {\n    height: auto;\n    line-height: 1.5;\n    margin-left: 30%;\n    width: 40%;\n    color: #fff;\n}\n.auth .brand-logo[data-v-0a273bdb] {\n    margin-bottom: 1 rem;\n}\ninput[data-v-0a273bdb]:focus {\n    border: 1px solid #e29826;\n}\n.auth form .auth-form-btn[data-v-0a273bdb]:hover {\n    border: 1px solid #e29826;\n    color: #e29826;\n}\n", ""]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Register_vue_vue_type_style_index_0_id_0a273bdb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Register.vue?vue&type=style&index=0&id=0a273bdb&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/auth/Register.vue?vue&type=style&index=0&id=0a273bdb&scoped=true&lang=css&");
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("h6", { staticClass: "font-weight-light text-left mt-4" }, [
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-check  text-left ml-4" }, [
          _c("label", {}, [
            _c("input", {
              directives: [
                {
